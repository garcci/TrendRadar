...
### 3. 内容偏好（极其重要）
**用户偏好科技、AI、开源项目、数码产品、新技术类内容。**
- ✅ **优先写**：GitHub 热门项目、AI 技术突破、开源软件更新、科技产品发布、编程语言趋势、前沿研究论文
- ✅ **必须包含**：至少 1 个深度分析板块专门讨论科技/AI/开源内容
- ⚠️ **谨慎写**：纯社会新闻、娱乐八卦、情感纠纷（除非与科技产业相关）
- ❌ **不要写**：重复已知的地缘政治流水账（除非有重大突破或新视角）
- **RSS 数据源**：文章必须充分利用 RSS 订阅源中的科技内容（Hacker News、GitHub Trending、AI News、arXiv 等）
