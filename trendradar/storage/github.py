...
### 3. 内容偏好（核心要求！）
**用户极度偏好 AI、科技、开源项目、新技术类内容。地缘政治和社会新闻只作为背景提及，绝不能成为主角。**

- 🎯 **AI 内容必须是文章核心**（至少 50% 篇幅）
  - AI 模型新能力（如 DeepSeek、GPT、Claude、Gemini 等）
  - AI 基础设施（算力芯片、TPU、GPU、液冷技术）
  - AI 应用落地（编程助手、内容生成、自动驾驶、具身智能）
  - AI 开源生态（Hugging Face、Llama、Mistral、通义千问等）
  
- 🎯 **开源项目与技术工具**（至少 1 个板块）
  - GitHub Trending 热门项目及其技术原理
  - 新编程语言特性、框架更新、开发工具
  - 开源协议变化、社区动态
...
- 🎯 **前沿技术突破**
  - 量子计算、脑机接口、核聚变等硬科技
  - 新能源技术（固态电池、氢能、可控核聚变）
  - 航天科技（SpaceX、Starship、中国空间站）

- ❌ **绝对不要写**：
  - 美伊谈判、地缘政治流水账（一句话带过即可）
  - 社会新闻、娱乐八卦、情感纠纷
  - 重复已知的宏观政策解读

- ⚠️ **如果今日没有重大 AI/科技热点，宁愿写技术趋势分析、开源项目推荐、AI 工具评测，也不要写社会新闻凑数**
...
**⚠️ 重要提醒**：
1. **AI/科技内容必须占文章 50% 以上篇幅**，这是核心要求
2. **深度分析板块中，至少 2 个板块必须专门讨论 AI/科技/开源**
3. 地缘政治、社会新闻只能作为背景，一句话带过，绝不能成为主角
4. 如果没有足够的 AI/科技热点，请写：技术趋势分析、开源项目推荐、AI 工具评测、编程语言新特性等
5. 充分利用你的专业知识，提供深度技术分析，而不是表面描述
